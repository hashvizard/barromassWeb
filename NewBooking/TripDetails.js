...
const CancelBooking =()=>{
  ...
  axios.post(`${url}/HomePage/CancelBooking.php`, {
    id:props.route.params.Bookid
  })
  .then(function (response) {
...
console.log(props.route.params.token)
  axios.post(`${url}/Notification/TripUpdate.php`, {
      token:props.route.params.token,
      title:"Trip Canceled",
      Description:"Your Refund will be credited to your Account within 7 working Days",
...
<View style={{padding:10,backgroundColor:"#f7f7f7",paddingTop:40,
            flexDirection:"row",justifyContent:"space-between"}}>
              ...
              onPress={()=>CancelBooking()}
               mode="contained">Cancel Booking</Button>
            </View>
