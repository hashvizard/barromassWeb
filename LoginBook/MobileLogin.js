 ...
 <View style={{flex:1,backgroundColor:Colors.White,
       ...
       padding:20}}>
          <View style={{flexDirection:"row",alignItems:"center"}}>
            ...
            <Icon name="close" size={30} style={{marginRight:15}} />
            </TouchableOpacity>
         <Image  source={require('../Assets/Front.png')}
          style={{width:100,height:100,aspectRatio:1/1,resizeMode:"contain"}} />
          </View>
               <Text style={{fontSize:25,color:"#292b2c"}}>Log in to Continue</Text>
...
onPress={() => {props.navigation.navigate("Otp",{MobileNumber:Mobile,Data:Data})}} loading={Verify}
