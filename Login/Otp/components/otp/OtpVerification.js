...
const Verified=()=>{
  ...
  .getToken()
  .then(token => {
    axios.post(`${url}/HomePage/MobileCheck.php`, {
    ...
    .then(function (response) {
        ...
        userinfo.login({id:props.route.params.MobileNumber,Admin:response.data == 0?false:true});
...
dark={false}
>
    {Verifing?"Logging you in":"Log-in"}
  </Button>
